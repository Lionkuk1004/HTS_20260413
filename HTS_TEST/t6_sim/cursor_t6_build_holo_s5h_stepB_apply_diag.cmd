@echo off
REM Step B: S5-HOLO + TRIAL printf + first P1-64 buf snapshot [V5A-APPLY].
REM Optional: HTS_DIAG_STEPB_S5H_CFO_HZ=200 limits arming to that true CFO only.
setlocal
...
cl /nologo /O2 /std:c++17 /EHsc /MD /W4 /WX /wd4324 /DNDEBUG ^
   ...
   /FeHTS_T6_SIM_Test_holo_s5h_stepB.exe ^

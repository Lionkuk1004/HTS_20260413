@echo off
REM Walsh preamble (no HTS_HOLO_PREAMBLE) + DIAG + S5 single CFO (HTS_DIAG_SINGLE_CFO).
REM Same as cursor_t6_build_diag.cmd except HOLO_PREAMBLE is omitted so phase0_scan_ runs.
REM Usage: cursor_t6_build_diag_walsh.cmd [cfo_hz_int]
REM   Default cfo_hz_int=5000. Example: cursor_t6_build_diag_walsh.cmd 0
setlocal
...
cl /nologo /O2 /std:c++17 /EHsc /MD /W3 ^
   ...
   /FeHTS_T6_SIM_Test_diag_walsh.exe ^

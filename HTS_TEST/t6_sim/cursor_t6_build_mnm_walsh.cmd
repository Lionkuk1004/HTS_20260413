@echo off
REM HTS_T6_SIM_Test_mnm_walsh.exe — cursor_t6_build.cmd + HTS_USE_MNM_WALSH (Walsh-aware M&M DPTE in V5a fine LR slot)
REM 회귀: Walsh baseline과 비교하려면 실행 후 T6 정량 합계를 동일 절차로 측정.
setlocal
...
cl /nologo /O2 /std:c++17 /EHsc /MD /W4 /WX /wd4324 /DNDEBUG ^
   ...
   /FeHTS_T6_SIM_Test_mnm_walsh.exe ^

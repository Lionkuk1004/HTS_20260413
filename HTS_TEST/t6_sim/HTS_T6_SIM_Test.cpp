...
# endif
    ...
    // [TASK-018] 5k–20k Hz: 1000 Hz 단위 보강 (S5 / S5F 동일 리스트)
    const double cfos[] = {
        0, 50, 100, 200, 500, 1000, 2000, 2500, 3000, 3500, 4000, 4500, 5000,
        6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000, 11000, 11500,
        12000, 12500, 13000, 14000, 15000, 16000, 17500, 18000, 19000, 20000,
        25000};

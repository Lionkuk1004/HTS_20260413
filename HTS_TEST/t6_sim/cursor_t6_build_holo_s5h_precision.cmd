@echo off
REM HTS_T6_SIM_Test_holo_s5h_precision.exe — holo + S5-HOLO 100Hz-class CFO grid (diag only)
setlocal
...
cl /nologo /O2 /std:c++17 /EHsc /MD /W4 /WX /wd4324 /DNDEBUG ^
   ...
   /DHTS_S5H_PRECISION_SWEEP ^
   /D_CRT_SECURE_NO_WARNINGS ^
   /FeHTS_T6_SIM_Test_holo_s5h_precision.exe ^

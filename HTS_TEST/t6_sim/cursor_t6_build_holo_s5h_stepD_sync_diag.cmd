@echo off
REM Step D: Step C harness + TX/RX 4D tensor seed/slot/mask/perm/rows [TX-*]/[RX-*].
setlocal
...
cl /nologo /O2 /std:c++17 /EHsc /MD /W4 /WX /wd4324 /DNDEBUG ^
   ...
   /DHTS_CFO_V5A_S5H_STEPD_TX ^
   /DHTS_CFO_V5A_S5H_STEPD_RX ^
   /D_CRT_SECURE_NO_WARNINGS ^
   /FeHTS_T6_SIM_Test_holo_s5h_stepD.exe ^

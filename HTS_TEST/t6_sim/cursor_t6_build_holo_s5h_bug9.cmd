@echo off
REM S5-HOLO BUG-9 matrix: [V5A-BUG9] lines + S5H-only main (HTS_V5A_BUG9_DIAG).
REM Requires HTS_CFO_V5A_S5H_TRIAL_DIAG: holographic V5a Estimate() is gated there.
REM 양산: 이 스크립트 미사용.
setlocal
call "C:\Program Files\Microsoft Visual Studio\18\Community\VC\Auxiliary\Build\vcvars64.bat" || exit /b 1
cd /d "%~dp0"

cl /nologo /O2 /std:c++17 /EHsc /MD /W4 /WX /wd4324 /wd4505 /DNDEBUG ^
   /I"." /I"..\..\HTS_LIM" ^
   ...
   /FeHTS_T6_SIM_Test_holo_s5h_bug9.exe ^

@echo off
REM HTS_T6_SIM_Test_holo_phaseB_derotate.exe — Phase B + HTS_HOLO_RX_PHASE_B_DEROTATE
setlocal
...
cl /nologo /O2 /std:c++17 /EHsc /MD /W4 /WX /wd4324 /DNDEBUG ^
   ...
   /DHTS_HOLO_RX_PHASE_B_DEROTATE ^
   /D_CRT_SECURE_NO_WARNINGS ^
   /FeHTS_T6_SIM_Test_holo_phaseB_derotate.exe ^

...
// =============================================================================
#pragma once
#ifndef HTS_V400_DISPATCHER_LOCAL_HPP
#define HTS_V400_DISPATCHER_LOCAL_HPP
// [Step A] 로컬 실험용 복사본. 메인트리 HTS_V400_Dispatcher.hpp 와 분리.
...
#define HTS_CCM_SECTION  /* PC: 섹션 속성 무시 */
    ...
    private:
        ...
        /// Walsh row XOR permuter — payload 심볼 스크램블 (CW 취약 주파수 회피)
        /// 프리앰블/헤더 제외, payload 만 적용 (RX 는 chip-domain 역변환으로 FEC 정합)
        Walsh_Row_Permuter walsh_permuter_;
        ...
        //  mags[64] + sorted[64] = 512B (blackhole_ 전용)
...
#endif // HTS_V400_DISPATCHER_LOCAL_HPP

@echo off
REM HTS_T6_SIM_Test_holo_4d_div.exe — cursor_t6_build_holo.cmd + HTS_USE_4D_DIVERSITY (TX B' DATA path)
REM T6 는 HTS_T6_SIM_Test.cpp 가 Dispatcher TX/Payload 등을 #include 로 통합 컴파일함.
REM RX Step 2-3c 미적용 시 점수는 참고용; 컴파일·링크 검증용.
setlocal
...
cl /nologo /O2 /std:c++17 /EHsc /MD /W4 /WX /wd4324 /DNDEBUG ^
   ...
   /DHTS_USE_4D_DIVERSITY ^
   /D_CRT_SECURE_NO_WARNINGS ^
   /FeHTS_T6_SIM_Test_holo_4d_div.exe ^

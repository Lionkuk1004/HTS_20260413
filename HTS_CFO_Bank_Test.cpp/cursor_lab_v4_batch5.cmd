@echo off
REM Batch 5: CFO 4000..5000 Hz @50 Hz (21 points)
...
if not exist "HTS_CFO_Bank_Test_v4.cpp" (
  ...
  echo Run: cd /d "...\HTS_CFO_Bank_Test.cpp" ^&^& cursor_lab_v4_batch5.cmd
  pause
  exit /b 1
)
set "HTS_LIM=%~dp0..\HTS_LIM"
set "CLBASE=/nologo /O2 /std:c++20 /EHsc /MD /W3 /DNDEBUG /D_CRT_SECURE_NO_WARNINGS /DHTS_USE_HOLO_TENSOR_4D /DHTS_ALLOW_HOST_BUILD /DHTS_CFO_V5A_ENABLE=1 /DNOGDI /DHTS_BATCH_5 /I"%HTS_LIM%""
cl %CLBASE% /Fe:HTS_CFO_Bank_Test_v4_b5.exe ^

@echo off
REM Option 4: v4 LR_AB 9-point — /DHTS_USE_PACD (V5a TU에 PaCD atan2 심볼 등; v4는 Dispatcher 미링크)
REM 출력: v4_mode_pacd_lr_ab_result.txt
setlocal
...
cl %CLBASE% /Fe:v4_mode_pacd.exe %SRC% /link /nologo
if errorlevel 1 exit /b 1

v4_mode_pacd.exe > v4_mode_pacd_lr_ab_result.txt 2>&1
endlocal
exit /b 0
